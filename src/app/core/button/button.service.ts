...
export class ButtonService {
  private defaultIcons: IButtonTypesConfig = {
    ...
    cancel:           { icon: 'co co-close',                label: 'default.buttons.cancel'           },
    change:           { icon: 'co co-change-status',        label: 'default.buttons.change'           }, // exchange-alt
    ...
    debtCard:         { icon: 'co co-dialog-info',          label: 'default.buttons.debtCard'         },
    ...
    info:             { icon: 'co co-dialog-info',          label: 'default.buttons.info'             },
    loadFromExcel:    { icon: 'co co-upload',               label: 'default.buttons.loadFromExcel'    },
    ...
    select:           { icon: 'fa fa-search',               label: 'default.buttons.select'           }, // crosshairs
    ...
    upload:           { icon: 'co co-upload',               label: 'default.buttons.upload'           },
