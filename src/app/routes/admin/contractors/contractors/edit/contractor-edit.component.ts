...
export class ContractorEditComponent {
  ...
  constructor(
    ...
    .take(1)
    .subscribe(([ contractorTypeOptions, contractor ]) => {
      this.initFormControls(contractorTypeOptions);
  ...
  private initFormControls(options: any): void {
    this.controls = [
      ...
      { label: 'contractors.grid.typeCode', controlName: 'typeCode', type: 'select', options },
