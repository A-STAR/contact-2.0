  ...
  controls: IDynamicFormGroup[] = [
    ...
    },
    {
      ...
      children: [
        ...
        { label: labelKey('debt.creditTypeCode'), controlName: 'creditTypeCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_PRODUCT_TYPE, disabled: true, width: 6 },
        ...
        { label: labelKey('debt.regionCode'), controlName: 'regionCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_DEBT_COMPONENTS, disabled: true, width: 6 },
        { label: labelKey('debt.branchCode'), controlName: 'branchCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_BRANCHES, disabled: true, width: 6 },
        { label: labelKey('debt.statusCode'), controlName: 'statusCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_DEBT_STATUS, disabled: true, width: 6 },
        ...
        { label: labelKey('debt.debtReasonCode'), controlName: 'debtReasonCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_DEBT_ORIGINATION_REASON, disabled: true, width: 6 },
        ...
        { label: labelKey('debt.lastPromStatusCode'), controlName: 'lastPromStatusCode', type: 'selectwrapper', dictCode: UserDictionariesService.DICTIONARY_PROMISE_STATUS, disabled: true, width: 6 },
        ...
        { label: labelKey('debt.lastCallDateTime'), controlName: 'lastCallDateTime', type: 'datepicker', disabled: true, width: 6 },
        { label: labelKey('debt.lastVisitDateTime'), controlName: 'lastVisitDateTime', type: 'datepicker', disabled: true, width: 6 },
        { label: labelKey('debt.nextCallDateTime'), controlName: 'nextCallDateTime', type: 'datepicker', disabled: true, width: 6 },
