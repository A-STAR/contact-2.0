...
export class ButtonService {
  private items: Map<ButtonType, ButtonConfig> = new Map([
    ...
    [ ButtonType.DEBT_CARD, { iconCls: 'co co-edit', label: `default.buttons.${ButtonType.DEBT_CARD}`  } ],
    ...
    [ ButtonType.HISTORY, { iconCls: 'co co-history', label: `default.buttons.${ButtonType.HISTORY}` } ],
