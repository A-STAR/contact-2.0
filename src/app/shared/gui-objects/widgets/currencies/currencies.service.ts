...
export class CurrenciesService extends AbstractActionService {
  ...
  fetchAll(forCurrentUser: boolean): Observable<Array<ICurrencies>> {
  ...
  fetch(groupId: number): Observable<ICurrencies> {
  ...
  create(group: ICurrencies): Observable<ICurrencies> {
  ...
  update(groupId: number, group: ICurrencies): Observable<any> {
